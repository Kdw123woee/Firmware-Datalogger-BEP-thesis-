/**
  ...
  *          COM port
  *          Joystick
  *          available on STM32U083C-DK board (MB1933) from STMicroelectronics.
  ******************************************************************************
  * @attention
  *
...
/** @defgroup STM32U083C_DK
  * @brief This file provides firmware functions to manage Leds, push-buttons,
  *        COM ports and joystick available on
  *        STM32U083C-DK discoveryuation board from STMicroelectronics.
  * @{
  */

/** @defgroup STM32U083C_DK_LOW_LEVEL LOW LEVEL
  * @{
  */

/** @defgroup STM32U083C_DK_COMMON_Private_Defines STM32U083C_DK COMMON Private Defines
  * @{
  */
...
/** @defgroup STM32U083C_DK_COMMON_Private_Macros STM32U083C_DK COMMON Private Macros
  * @{
  */
...
/** @defgroup STM32U083C_DK_LOW_LEVEL_Private_TypesDefinitions LOW LEVEL Private Types Definitions
  * @{
  */
...
/** @defgroup STM32U083C_DK_LOW_LEVEL_Exported_Variables LOW LEVEL Exported Variables
  * @{
  */
...
/** @defgroup STM32U083C_DK_LOW_LEVEL_Private_Variables LOW LEVEL Private Variables
  * @{
  */
...
static uint32_t IsJoyMspCbValid[JOYn] = {0};
...
/** @defgroup STM32U083C_DK_LOW_LEVEL_Private_FunctionPrototypes  LOW LEVEL Private Function Prototypes
  * @{
  */
...
/** @defgroup STM32U083C_DK_LOW_LEVEL_Exported_Functions LOW LEVEL Exported Functions
  * @{
  */

/**
  * @brief  This method returns the STM32U083C DK BSP Driver revision
  * @retval version : 0xXYZR (8bits for each decimal, R for RC)
  */
int32_t BSP_GetVersion(void)
{
  return STM32U083C_DK_BSP_VERSION;
}
...
{
  return (uint8_t *)STM32U083C_DK_BSP_BOARD_NAME;
}
...
{
  return (uint8_t *)STM32U083C_DK_BSP_BOARD_ID;
}
...
__weak HAL_StatusTypeDef MX_ADC_Init(ADC_HandleTypeDef *hadc)
{
  ...
  hadc->Init.ClockPrescaler        = ADC_CLOCK_SYNC_PCLK_DIV4;   /* ADC clock of STM32U0 must not exceed 14MHz        */
